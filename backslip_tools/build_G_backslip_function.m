function [GExx_top_fine,GExy_top_fine,GEyy_top_fine]=...
...
cnt = 0;
GExx_top_fine = zeros(size(G1Exx_top,1),length(pm_top_seg_num));
GExy_top_fine = zeros(size(G1Exx_top,1),length(pm_top_seg_num));
GEyy_top_fine = zeros(size(G1Exx_top,1),length(pm_top_seg_num));
