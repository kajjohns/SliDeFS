function U=backslip_cycle3D_layered_noelastic(m,xloc,H1,H2,mu,lam,t,tR1,tR2,T,Nterms)
...
%U=U;  %-Ue;  %the negative sign on the first term is needed because the sign of slip is backwards from what is expected in Okada
